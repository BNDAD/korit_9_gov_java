...
public class Array04 {
    public static String[] names = new String[]{"김준일", "김준2", "김준3", "김준4", "김준5", "김준6", "김준7", "김준8", "김준9", "김준10"};
    ...
    public static String[] pagination(int page, int size) {
        ...
        int pagenationArraySize = isLast && names.length % size != 0 ? names.length % size : size;
        String[] paginationArray = new String[pagenationArraySize];
        for (int i = startIndex; i < startIndex + pagenationArraySize; i++) {

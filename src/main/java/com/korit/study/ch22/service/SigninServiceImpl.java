...
import com.korit.study.ch22.repository.UserRepositoryImp;
import com.korit.study.ch22.repository.UserRepositoryImp2;
...
public class SigninServiceImpl implements SigninService {
    ...
    public static SigninServiceImpl getInstance() {
        if (Objects.isNull(instance)) {
            instance = new SigninServiceImpl(UserRepositoryImp2.getInstance());
        }
        return instance;
    }

...
class VipUser extends User {
    public VipUser(String usernmae, String password) {
        super(usernmae, password);
    }
}


class GoldUser extends User {
    public GoldUser(String usernmae, String password) {
        super(usernmae, password);
    }
}
...
//        main.printAll(names);
    ...
    /**
     * 와일드 카드 >>> '?' 기호
     * 어떤 타입인지 알 수 없다. 즉, 모든 타입을 유추하여 받ㅇ르 수 있는 방법
     *
